...
public class SpectrumViewMain extends Activity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.spectrum_view_main);

        //MODIFICATO: costruitsco l'array che conterrà i valori delle canzoni e l'adapter per visualizzarle
        arrayOfSongs = new ArrayList<Songs>();
        adapter = new SongsAdapter(SpectrumViewMain.this, arrayOfSongs);
        ...
        if(ContextCompat.checkSelfPermission(SpectrumViewMain.this, Manifest.permission.READ_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED)
        {
            if(ActivityCompat.shouldShowRequestPermissionRationale(SpectrumViewMain.this, Manifest.permission.READ_EXTERNAL_STORAGE)) {

                ActivityCompat.requestPermissions(SpectrumViewMain.this, new String[]{Manifest.permission.READ_EXTERNAL_STORAGE}, MY_PERMISSION_REQUEST);
            }
            else {
    ...
    public void doStuff() {
        ...
        //mSongNames = (ListView) findViewById(R.id.ID_MPMListView);
        //mArrayList = new ArrayList<>();

        //MODIFICATO
        mSongNames = (ListView) findViewById(R.id.ID_SpecM_listView);
        ...
        mSongNames.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
                ...
                Intent mSpectrumPlayIntent = new Intent(SpectrumViewMain.this, SpectrumViewPlay.class);

                mSpectrumPlayIntent.putExtra("ExtraPosition", position);
                mSpectrumPlayIntent.putExtra("StringArray", mListOfPaths);

                startActivity(mSpectrumPlayIntent);
